...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47297 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47297(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_47298 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_47298(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_47299 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_47299(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_47300 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_47300(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47305 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47305(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47306 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47306(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__47292,callback){
var map__47293 = p__47292;
var map__47293__$1 = cljs.core.__destructure_map(map__47293);
var input = map__47293__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47293__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47293__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
