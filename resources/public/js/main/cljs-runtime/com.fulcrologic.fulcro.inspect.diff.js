...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__40353){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__40357){
...
var vec__40361 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40361,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40361,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__40364 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40364,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__40364;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__40365){
var map__40366 = p__40365;
var map__40366__$1 = cljs.core.__destructure_map(map__40366);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40366__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__40368){
var map__40369 = p__40368;
var map__40369__$1 = cljs.core.__destructure_map(map__40369);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40369__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__40370 = cljs.core.first(rem);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40370,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40370,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__40367_SHARP_){
var G__40373 = p1__40367_SHARP_;
var G__40374 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__40373,G__40374) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__40373,G__40374));
}));
} else {
