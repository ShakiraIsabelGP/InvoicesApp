...
var i_40708 = (0);
while(true){
if((i_40708 < arr.length)){
(arr[i_40708] = null);

var G__40709 = (i_40708 + (1));
i_40708 = G__40709;
continue;
} else {
}
...
var i_40716 = (self__.level + (1));
while(true){
if((i_40716 <= (new_level + (1)))){
(update[i_40716] = self__.header);

var G__40717 = (i_40716 + (1));
i_40716 = G__40717;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_40718 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_40718[i]));
} else {
x__$2.forward.push((((i < links_40718.length))?(links_40718[i]):null));
}

if((i < links_40718.length)){
(links_40718[i] = x__$2);
} else {
links_40718.push(x__$2);
}
...
var i_40720 = (0);
while(true){
if((i_40720 <= self__.level)){
var links_40721 = (update[i_40720]).forward;
if((x__$1 === (((i_40720 < links_40721.length))?(links_40721[i_40720]):null))){
(links_40721[i_40720] = (x__$1.forward[i_40720]));

var G__40722 = (i_40720 + (1));
i_40720 = G__40722;
continue;
} else {
var G__40723 = (i_40720 + (1));
i_40720 = G__40723;
continue;
}
} else {
...
var G__40725 = nx;
var G__40726 = (level__$1 - (1));
x = G__40725;
level__$1 = G__40726;
continue;
} else {
var G__40727 = x;
var G__40728 = (level__$1 - (1));
x = G__40727;
level__$1 = G__40728;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__40730 = nx;
var G__40731 = (level__$1 - (1));
x = G__40730;
level__$1 = G__40731;
continue;
} else {
var G__40732 = x;
var G__40733 = (level__$1 - (1));
x = G__40732;
level__$1 = G__40733;
continue;
}
