...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49345){
...
var ident = (function (){var G__49355 = data__$1;
var G__49355__$1 = (((G__49355 == null))?null:com.fulcrologic.fulcro.algorithms.normalize.hide_not_found(G__49355));
if((G__49355__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.raw.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,G__49355__$1);
}
})();
...
}),null)),null,-37705652,null);
} else {
}

return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__49356 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__49357 = data__$1;
var G__49358 = tables;
var G__49359 = union_seen;
var G__49360 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__49356,G__49357,G__49358,G__49359,G__49360) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__49356,G__49357,G__49358,G__49359,G__49360));
...
var vec__49377 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var join_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49377,(0),null);
var subquery = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49377,(1),null);
...
var G__49424 = cljs.core.next(q);
var G__49425 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,i);
q = G__49424;
ret = G__49425;
continue;
} else {
var G__49426 = cljs.core.next(q);
var G__49427 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,x);
q = G__49426;
ret = G__49427;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (p1__49352_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(subquery__$1,p1__49352_SHARP_,tables,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,subquery__$1,p1__49352_SHARP_,tables,union_entry,transform));
});})(q,ret,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.raw.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (p1__49353_SHARP_){
return com.fulcrologic.fulcro.raw.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,com.fulcrologic.fulcro.algorithms.normalize.hide_not_found(p1__49353_SHARP_));
});})(q,ret,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(subquery__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(tables,((function (q,ret,is,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (tables_SINGLEQUOTE_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function com$fulcrologic$fulcro$algorithms$normalize$normalize_STAR__$_merge_to_client_db(state,p__49380){
var vec__49381 = p__49380;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49381,(0),null);
var entity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49381,(1),null);
return com.fulcrologic.fulcro.algorithms.normalize.upsert_ident(state,ident,entity);
});})(q,ret,is,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
...
return (function (tables_SINGLEQUOTE_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function com$fulcrologic$fulcro$algorithms$normalize$normalize_STAR__$_merge_to_client_db(state,p__49387){
var vec__49388 = p__49387;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49388,(0),null);
var entity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49388,(1),null);
return com.fulcrologic.fulcro.algorithms.normalize.upsert_ident(state,ident,entity);
});})(q,ret,is,xs,vec__49377,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
...
var G__49428 = cljs.core.next(q);
var G__49429 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,is);
q = G__49428;
ret = G__49429;
continue;
} else {
var G__49430 = cljs.core.next(q);
var G__49431 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,xs);
q = G__49430;
ret = G__49431;
continue;
}
...
if((v == null)){
var G__49432 = cljs.core.next(q);
var G__49433 = ret;
q = G__49432;
ret = G__49433;
continue;
} else {
var G__49434 = cljs.core.next(q);
var G__49435 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,v);
q = G__49434;
ret = G__49435;
continue;
...
if((v == null)){
var G__49436 = cljs.core.next(q);
var G__49437 = ret;
q = G__49436;
ret = G__49437;
continue;
} else {
var G__49438 = cljs.core.next(q);
var G__49439 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__49438;
ret = G__49439;
continue;
}
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Normalize failed and no data will be inserted into the client DB. Error:",cljs.core.ex_message(e),(function (){var temp__5802__auto__ = (function (){var G__49392 = query;
var G__49392__$1 = (((G__49392 == null))?null:cljs.core.meta(G__49392));
var G__49392__$2 = (((G__49392__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__49392__$1));
if((G__49392__$2 == null)){
return null;
} else {
return com.fulcrologic.fulcro.raw.components.component_name(G__49392__$2);
}
})();
