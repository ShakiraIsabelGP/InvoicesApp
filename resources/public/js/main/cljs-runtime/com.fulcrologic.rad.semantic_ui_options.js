 ...
 */
com.fulcrologic.rad.semantic_ui_options.report_controls_row_class = new cljs.core.Keyword("com.fulcrologic.rad.semantic-ui-options","report-controls-row-class","com.fulcrologic.rad.semantic-ui-options/report-controls-row-class",-2113477357);
/**
...
var len__5769__auto___91776 = arguments.length;
var i__5770__auto___91777 = (0);
while(true){
if((i__5770__auto___91777 < len__5769__auto___91776)){
args__5775__auto__.push((arguments[i__5770__auto___91777]));

var G__91778 = (i__5770__auto___91777 + (1));
i__5770__auto___91777 = G__91778;
continue;
} else {
}
break;
...
return com.fulcrologic.rad.semantic_ui_options.get_rendering_options.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5776__auto__);
});
...
var global_options = (function (){var G__91775 = app;
var G__91775__$1 = (((G__91775 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772).cljs$core$IFn$_invoke$arity$1(G__91775));
var G__91775__$2 = (((G__91775__$1 == null))?null:cljs.core.deref(G__91775__$1));
if((G__91775__$2 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.rad.semantic-ui-options","rendering-options","com.fulcrologic.rad.semantic-ui-options/rendering-options",-1090892612).cljs$core$IFn$_invoke$arity$1(G__91775__$2);
}
})();
...
/** @this {Function} */
(com.fulcrologic.rad.semantic_ui_options.get_rendering_options.cljs$lang$applyTo = (function (seq91773){
var G__91774 = cljs.core.first(seq91773);
var seq91773__$1 = cljs.core.next(seq91773);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__91774,seq91773__$1);
}));
