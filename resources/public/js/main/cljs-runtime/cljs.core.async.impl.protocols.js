...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40607 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40607(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40608 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40608(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40609 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40609(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40610 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40610(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40611 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40611(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40612 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40612(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40613 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40613(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40614 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40614(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40615 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40615(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40616 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40616(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40617 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40617(b);
}
});
