...
var map__70826 = app;
var map__70826__$1 = cljs.core.__destructure_map(map__70826);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70826__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var raf_70834 = (((typeof requestAnimationFrame !== 'undefined'))?requestAnimationFrame:(function (p1__70828_SHARP_){
return com.fulcrologic.fulcro.algorithms.scheduling.defer(p1__70828_SHARP_,(16));
}));
/**
...
var map__70829 = app;
var map__70829__$1 = cljs.core.__destructure_map(map__70829);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70829__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);
...
return (raf_70834.cljs$core$IFn$_invoke$arity$1 ? raf_70834.cljs$core$IFn$_invoke$arity$1(f) : raf_70834.call(null,f));
}
});
