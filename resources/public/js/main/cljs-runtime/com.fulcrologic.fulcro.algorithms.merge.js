...
return cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49553_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(ident,p1__49553_SHARP_);
}),old_list));
});
...
var G__49554 = kw__$1;
var G__49554__$1 = (((G__49554 == null))?null:cljs.core.namespace(G__49554));
if((G__49554__$1 == null)){
return null;
} else {
return cljs.core.re_find(/^ui(?:\.|$)/,G__49554__$1);
}
} else {
return null;
}
...
var mock_missing_object = (function (){var G__49555 = cljs.core.PersistentArrayMap.EMPTY;
var G__49556 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__49555,G__49556) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__49555,G__49556));
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,jk,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (item){
var G__49557 = item;
var G__49558 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__49557,G__49558) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__49557,G__49558));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,jk,(function (){var G__49559 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(result__$1,jk);
var G__49560 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__49559,G__49560) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__49559,G__49560));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,result_key,(function (){var G__49561 = cljs.core.PersistentArrayMap.EMPTY;
var G__49562 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__49561,G__49562) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__49561,G__49562));
})());
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49564){
var vec__49565 = p__49564;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49565,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49565,(1),null);
...
if((((!(com.fulcrologic.fulcro.algorithms.tempid.tempid_QMARK_(m)))) && (cljs.core.map_QMARK_(m)))){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49568){
var vec__49569 = p__49568;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49569,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49569,(1),null);
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.merge","not-found","com.fulcrologic.fulcro.algorithms.merge/not-found",190673437),k)) || (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.merge","not-found","com.fulcrologic.fulcro.algorithms.merge/not-found",190673437),v)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tempids","tempids",1767509089),k)))))){
return acc;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49572){
var vec__49573 = p__49572;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49573,(0),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49573,(1),null);
...
var entity = (function (){var G__49576 = com.fulcrologic.fulcro.raw.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,data);
if((G__49576 == null)){
return null;
} else {
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,G__49576);
}
})();
...
var G__49581 = com.fulcrologic.fulcro.algorithms.merge.sweep_merge(updated_state,db);
var G__49581__$1 = (cljs.core.truth_(target)?com.fulcrologic.fulcro.algorithms.data_targeting.process_target.cljs$core$IFn$_invoke$arity$3(G__49581,idnt,target):G__49581);
if(cljs.core.not(target)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__49581__$1,db,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([idnt], 0));
} else {
return G__49581__$1;
}
} else {
...
var map__49583 = cljs.core.group_by((function (p1__49582_SHARP_){
return cljs.core.vector_QMARK_(cljs.core.first(p1__49582_SHARP_));
}),res);
var map__49583__$1 = cljs.core.__destructure_map(map__49583);
var idents = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49583__$1,true);
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49583__$1,false);
...
var source_to_merge = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__49584){
var vec__49585 = p__49584;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49585,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49585,(1),null);
...
var ident_joins = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__49588_SHARP_){
var G__49590 = p1__49588_SHARP_;
if(cljs.core.seq_QMARK_(p1__49588_SHARP_)){
return cljs.core.first(G__49590);
} else {
return G__49590;
}
})),cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__49589_SHARP_){
return ((com.fulcrologic.fulcro.algorithms.do_not_use.join_QMARK_(p1__49589_SHARP_)) && (edn_query_language.core.ident_QMARK_(com.fulcrologic.fulcro.algorithms.do_not_use.join_key(p1__49589_SHARP_))));
}))),query);
var step = (function com$fulcrologic$fulcro$algorithms$merge$merge_idents_$_step(result_tree,p__49595){
var vec__49596 = p__49595;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49596,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49596,(1),null);
...
var vec__49601 = com.fulcrologic.fulcro.algorithms.merge.sift_idents(result_tree);
var idts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49601,(0),null);
var result_tree__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49601,(1),null);
...
var com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__3 = (function (p__49610,visitor,parent_union){
var map__49611 = p__49610;
var map__49611__$1 = cljs.core.__destructure_map(map__49611);
var parent_ast = map__49611__$1;
...
var component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49611__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49611__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49611__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49611__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49611__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var seq__49612 = cljs.core.seq(children);
var chunk__49613 = null;
var count__49614 = (0);
var i__49615 = (0);
while(true){
if((i__49615 < count__49614)){
var ast = chunk__49613.cljs$core$IIndexed$_nth$arity$2(null,i__49615);
...
var G__49665 = seq__49612;
var G__49666 = chunk__49613;
var G__49667 = count__49614;
var G__49668 = (i__49615 + (1));
seq__49612 = G__49665;
chunk__49613 = G__49666;
count__49614 = G__49667;
i__49615 = G__49668;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__49612);
if(temp__5804__auto__){
var seq__49612__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__49612__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__49612__$1);
var G__49669 = cljs.core.chunk_rest(seq__49612__$1);
var G__49670 = c__5568__auto__;
var G__49671 = cljs.core.count(c__5568__auto__);
var G__49672 = (0);
seq__49612 = G__49669;
chunk__49613 = G__49670;
count__49614 = G__49671;
i__49615 = G__49672;
continue;
} else {
var ast = cljs.core.first(seq__49612__$1);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast),new cljs.core.Keyword(null,"union","union",2142937499))){
com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast.cljs$core$IFn$_invoke$arity$3(ast,visitor,component);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast),new cljs.core.Keyword(null,"union-entry","union-entry",223335750))){
...
var G__49673 = cljs.core.next(seq__49612__$1);
var G__49674 = null;
var G__49675 = (0);
var G__49676 = (0);
seq__49612 = G__49673;
chunk__49613 = G__49674;
count__49614 = G__49675;
i__49615 = G__49676;
continue;
}
} else {
...
com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast = function(p__49610,visitor,parent_union){
switch(arguments.length){
case 2:
return com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__2.call(this,p__49610,visitor);
case 3:
return com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__3.call(this,p__49610,visitor,parent_union);
}
...
var G__49618 = app;
var G__49619 = cljs.core.PersistentArrayMap.EMPTY;
return (render_BANG_.cljs$core$IFn$_invoke$arity$2 ? render_BANG_.cljs$core$IFn$_invoke$arity$2(G__49618,G__49619) : render_BANG_.call(null,G__49618,G__49619));
} else {
return null;
}
}));
...
var len__5769__auto___49683 = arguments.length;
var i__5770__auto___49684 = (0);
while(true){
if((i__5770__auto___49684 < len__5769__auto___49683)){
args__5775__auto__.push((arguments[i__5770__auto___49684]));

var G__49686 = (i__5770__auto___49684 + (1));
i__5770__auto___49684 = G__49686;
continue;
} else {
}
break;
...
var map__49624 = options;
var map__49624__$1 = cljs.core.__destructure_map(map__49624);
var remove_missing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49624__$1,new cljs.core.Keyword(null,"remove-missing?","remove-missing?",-2044119224));
...
var integrate_params = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__49625){
var vec__49626 = p__49625;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49626,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49626,(1),null);
if(cljs.core.truth_((function (){var fexpr__49629 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"replace","replace",-786587770),null,new cljs.core.Keyword(null,"prepend","prepend",342616040),null,new cljs.core.Keyword(null,"append","append",-291298229),null], null), null);
return (fexpr__49629.cljs$core$IFn$_invoke$arity$1 ? fexpr__49629.cljs$core$IFn$_invoke$arity$1(k) : fexpr__49629.call(null,k));
})())){
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.merge.merge_component.cljs$lang$applyTo = (function (seq49620){
var G__49621 = cljs.core.first(seq49620);
var seq49620__$1 = cljs.core.next(seq49620);
var G__49622 = cljs.core.first(seq49620__$1);
var seq49620__$2 = cljs.core.next(seq49620__$1);
var G__49623 = cljs.core.first(seq49620__$2);
var seq49620__$3 = cljs.core.next(seq49620__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49621,G__49622,G__49623,seq49620__$3);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___49690 = arguments.length;
var i__5770__auto___49691 = (0);
while(true){
if((i__5770__auto___49691 < len__5769__auto___49690)){
args__5775__auto__.push((arguments[i__5770__auto___49691]));

var G__49692 = (i__5770__auto___49691 + (1));
i__5770__auto___49691 = G__49692;
continue;
} else {
}
break;
...
var G__49634 = app__$1;
var G__49635 = cljs.core.PersistentArrayMap.EMPTY;
return (render_BANG_.cljs$core$IFn$_invoke$arity$2 ? render_BANG_.cljs$core$IFn$_invoke$arity$2(G__49634,G__49635) : render_BANG_.call(null,G__49634,G__49635));
}
} else {
return null;
}
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.merge.merge_component_BANG_.cljs$lang$applyTo = (function (seq49630){
...
var G__49633 = cljs.core.first(seq49630__$2);
var seq49630__$3 = cljs.core.next(seq49630__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49631,G__49632,G__49633,seq49630__$3);
}));
