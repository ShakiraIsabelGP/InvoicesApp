...
var G__82318 = clojure.zip.node(loc);
var fexpr__82317 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__82317.cljs$core$IFn$_invoke$arity$1 ? fexpr__82317.cljs$core$IFn$_invoke$arity$1(G__82318) : fexpr__82317.call(null,G__82318));
});
/**
...
var G__82320 = clojure.zip.node(loc);
var fexpr__82319 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__82319.cljs$core$IFn$_invoke$arity$1 ? fexpr__82319.cljs$core$IFn$_invoke$arity$1(G__82320) : fexpr__82319.call(null,G__82320));
} else {
...
var fexpr__82321 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__82321.cljs$core$IFn$_invoke$arity$2 ? fexpr__82321.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__82321.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__82323 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82323,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82323,(1),null);
var vec__82326 = clojure.zip.children(loc);
var seq__82327 = cljs.core.seq(vec__82326);
var first__82328 = cljs.core.first(seq__82327);
var seq__82327__$1 = cljs.core.next(seq__82327);
var c = first__82328;
var cnext = seq__82327__$1;
var cs = vec__82326;
...
var vec__82330 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82330,(0),null);
var map__82333 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82330,(1),null);
var map__82333__$1 = cljs.core.__destructure_map(map__82333);
var path = map__82333__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82333__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82333__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82333__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82333__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82333__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__82334 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82334,(0),null);
var map__82337 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82334,(1),null);
var map__82337__$1 = cljs.core.__destructure_map(map__82337);
var path = map__82337__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82337__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__82338 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82337__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__82339 = cljs.core.seq(vec__82338);
var first__82340 = cljs.core.first(seq__82339);
var seq__82339__$1 = cljs.core.next(seq__82339);
var r = first__82340;
var rnext = seq__82339__$1;
var rs = vec__82338;
...
var vec__82341 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82341,(0),null);
var map__82344 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82341,(1),null);
var map__82344__$1 = cljs.core.__destructure_map(map__82344);
var path = map__82344__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82344__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82344__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__82354 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82354,(0),null);
var map__82357 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82354,(1),null);
var map__82357__$1 = cljs.core.__destructure_map(map__82357);
var path = map__82357__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82357__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82357__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__82358 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82358,(0),null);
var map__82361 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82358,(1),null);
var map__82361__$1 = cljs.core.__destructure_map(map__82361);
var path = map__82361__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82361__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82361__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__82362 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82362,(0),null);
var map__82365 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82362,(1),null);
var map__82365__$1 = cljs.core.__destructure_map(map__82365);
var path = map__82365__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82365__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__82367 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82367,(0),null);
var map__82370 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82367,(1),null);
var map__82370__$1 = cljs.core.__destructure_map(map__82370);
var path = map__82370__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82370__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__82372 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82372,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82372,(1),null);
...
var len__5769__auto___82402 = arguments.length;
var i__5770__auto___82403 = (0);
while(true){
if((i__5770__auto___82403 < len__5769__auto___82402)){
args__5775__auto__.push((arguments[i__5770__auto___82403]));

var G__82404 = (i__5770__auto___82403 + (1));
i__5770__auto___82403 = G__82404;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq82375){
var G__82376 = cljs.core.first(seq82375);
var seq82375__$1 = cljs.core.next(seq82375);
var G__82377 = cljs.core.first(seq82375__$1);
var seq82375__$2 = cljs.core.next(seq82375__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__82376,G__82377,seq82375__$2);
}));
...
var G__82406 = clojure.zip.rightmost(child);
loc__$1 = G__82406;
continue;
} else {
return loc__$1;
...
var vec__82384 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82384,(0),null);
var map__82387 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82384,(1),null);
var map__82387__$1 = cljs.core.__destructure_map(map__82387);
var path = map__82387__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82387__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82387__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82387__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82387__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__82410 = clojure.zip.rightmost(child);
loc__$1 = G__82410;
continue;
} else {
return loc__$1;
