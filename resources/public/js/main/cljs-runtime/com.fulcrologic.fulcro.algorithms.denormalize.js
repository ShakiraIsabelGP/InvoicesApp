 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__48129){
var vec__48130 = p__48129;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48130,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48130,(1),null);
var ref = vec__48130;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__48154){
var vec__48156 = p__48154;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48156,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48156,(1),null);
var ref = vec__48156;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__48160){
var map__48161 = p__48160;
var map__48161__$1 = cljs.core.__destructure_map(map__48161);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48161__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5802__auto__ = (function (){var and__5043__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__48171,entity,state_map,parent_node,idents_seen){
var map__48172 = p__48171;
var map__48172__$1 = cljs.core.__destructure_map(map__48172);
var join_node = map__48172__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48172__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48172__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"warn","warn",-436710552),"com.fulcrologic.fulcro.algorithms.denormalize",null,113,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"warn","warn",-436710552),"com.fulcrologic.fulcro.algorithms.denormalize",null,129,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
if(cljs.core.truth_((function (){var and__5043__auto__ = recursive_QMARK_;
if(and__5043__auto__){
return join_entity;
} else {
return and__5043__auto__;
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__48187,entity,state_map,idents_seen){
var map__48188 = p__48187;
var map__48188__$1 = cljs.core.__destructure_map(map__48188);
var join_node = map__48188__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48188__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__48189){
var map__48223 = p__48189;
var map__48223__$1 = cljs.core.__destructure_map(map__48223);
var node = map__48223__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48223__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5802__auto__ = (function (){var and__5043__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__5043__auto__){
...
var vec__48231 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48231,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__48235 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__48235) : union_key__GT_query.call(null,G__48235));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__48238,current_entity,state_map,idents_seen){
var map__48239 = p__48238;
var map__48239__$1 = cljs.core.__destructure_map(map__48239);
var top_node = map__48239__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48239__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48239__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var wildcard_QMARK_ = (function (){var and__5043__auto__ = nil_nodes;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__48240 = nil_nodes;
var G__48240__$1 = (((G__48240 == null))?null:cljs.core.first(G__48240));
if((G__48240__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__48240__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__48241 = result_node__$1;
var G__48241__$1 = (((G__48241 == null))?null:cljs.core.persistent_BANG_(G__48241));
if((G__48241__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__48241__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__48242 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__48243 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__48243);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__48244 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__48244 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__48244,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__48242);
}});
/**
...
var G__48246 = props;
var G__48246__$1 = (((G__48246 == null))?null:cljs.core.meta(G__48246));
if((G__48246__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__48246__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__48253 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__48254 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__48254);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__48253);
}});
/**
...
var map__48255 = cljs.core.meta(prior_props);
var map__48255__$1 = cljs.core.__destructure_map(map__48255);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48255__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48255__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
