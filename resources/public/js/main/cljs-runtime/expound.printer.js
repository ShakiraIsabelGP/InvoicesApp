...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43396_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__43396_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43397_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43397_SHARP_)));
}),row));
});
...
var G__43400 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__43401 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__43400,G__43401) : expound.printer.format.call(null,G__43400,G__43401));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43406_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43406_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43407_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43407_SHARP_)).length),"="));
}),header);
...
var iter__5523__auto__ = (function expound$printer$multirow_$_iter__43416(s__43417){
...
var row_idx = cljs.core._nth(c__5521__auto__,i__43418);
cljs.core.chunk_append(b__43419,(function (){var iter__5523__auto__ = ((function (i__43418,row_idx,c__5521__auto__,size__5522__auto__,b__43419,s__43417__$2,temp__5804__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__43416_$_iter__43431(s__43432){
return (new cljs.core.LazySeq(null,((function (i__43418,row_idx,c__5521__auto__,size__5522__auto__,b__43419,s__43417__$2,temp__5804__auto__,split_row_contents){
return (function (){
var s__43432__$1 = s__43432;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__43432__$1);
if(temp__5804__auto____$1){
var s__43432__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43432__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__43432__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__43434 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__43433 = (0);
while(true){
if((i__43433 < size__5522__auto____$1)){
var col_idx = cljs.core._nth(c__5521__auto____$1,i__43433);
cljs.core.chunk_append(b__43434,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__43708 = (i__43433 + (1));
i__43433 = G__43708;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43434),expound$printer$multirow_$_iter__43416_$_iter__43431(cljs.core.chunk_rest(s__43432__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43434),null);
}
} else {
var col_idx = cljs.core.first(s__43432__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__43416_$_iter__43431(cljs.core.rest(s__43432__$2)));
}
} else {
return null;
}
...
});})(i__43418,row_idx,c__5521__auto__,size__5522__auto__,b__43419,s__43417__$2,temp__5804__auto__,split_row_contents))
,null,null));
});})(i__43418,row_idx,c__5521__auto__,size__5522__auto__,b__43419,s__43417__$2,temp__5804__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43419),expound$printer$multirow_$_iter__43416(cljs.core.chunk_rest(s__43417__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43419),null);
}
} else {
var row_idx = cljs.core.first(s__43417__$2);
return cljs.core.cons((function (){var iter__5523__auto__ = ((function (row_idx,s__43417__$2,temp__5804__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__43416_$_iter__43435(s__43436){
return (new cljs.core.LazySeq(null,(function (){
var s__43436__$1 = s__43436;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__43436__$1);
if(temp__5804__auto____$1){
var s__43436__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43436__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__43436__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__43438 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__43437 = (0);
while(true){
if((i__43437 < size__5522__auto__)){
var col_idx = cljs.core._nth(c__5521__auto__,i__43437);
cljs.core.chunk_append(b__43438,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__43711 = (i__43437 + (1));
i__43437 = G__43711;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43438),expound$printer$multirow_$_iter__43416_$_iter__43435(cljs.core.chunk_rest(s__43436__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43438),null);
}
} else {
var col_idx = cljs.core.first(s__43436__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__43416_$_iter__43435(cljs.core.rest(s__43436__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__43417__$2,temp__5804__auto__,split_row_contents))
;
return iter__5523__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__43416(cljs.core.rest(s__43417__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43441_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__43441_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__43451 = via;
var G__43451__$1 = (((G__43451 == null))?null:cljs.core.last(G__43451));
if((G__43451__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__43451__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43449_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__43449_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43450_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__43450_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__43456_43764 = cljs.core.seq(problems);
var chunk__43457_43765 = null;
var count__43458_43766 = (0);
var i__43459_43767 = (0);
while(true){
if((i__43459_43767 < count__43458_43766)){
var p_43768 = chunk__43457_43765.cljs$core$IIndexed$_nth$arity$2(null,i__43459_43767);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_43768) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__43769 = seq__43456_43764;
var G__43770 = chunk__43457_43765;
var G__43771 = count__43458_43766;
var G__43772 = (i__43459_43767 + (1));
seq__43456_43764 = G__43769;
chunk__43457_43765 = G__43770;
count__43458_43766 = G__43771;
i__43459_43767 = G__43772;
continue;
} else {
var temp__5804__auto___43773 = cljs.core.seq(seq__43456_43764);
if(temp__5804__auto___43773){
var seq__43456_43774__$1 = temp__5804__auto___43773;
if(cljs.core.chunked_seq_QMARK_(seq__43456_43774__$1)){
var c__5568__auto___43775 = cljs.core.chunk_first(seq__43456_43774__$1);
var G__43776 = cljs.core.chunk_rest(seq__43456_43774__$1);
var G__43777 = c__5568__auto___43775;
var G__43778 = cljs.core.count(c__5568__auto___43775);
var G__43779 = (0);
seq__43456_43764 = G__43776;
chunk__43457_43765 = G__43777;
count__43458_43766 = G__43778;
i__43459_43767 = G__43779;
continue;
} else {
var p_43780 = cljs.core.first(seq__43456_43774__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_43780) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__43781 = cljs.core.next(seq__43456_43774__$1);
var G__43782 = null;
var G__43783 = (0);
var G__43784 = (0);
seq__43456_43764 = G__43781;
chunk__43457_43765 = G__43782;
count__43458_43766 = G__43783;
i__43459_43767 = G__43784;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__5045__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43455_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__43455_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__43492){
var vec__43494 = p__43492;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43494,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43494,(1),null);
var G__43497 = branch;
var G__43497__$1 = (((G__43497 instanceof cljs.core.Keyword))?G__43497.fqn:null);
switch (G__43497__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43497__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__43501 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43501,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43501,(1),null);
var G__43505 = branch;
...
var len__5769__auto___43793 = arguments.length;
var i__5770__auto___43794 = (0);
while(true){
if((i__5770__auto___43794 < len__5769__auto___43793)){
args__5775__auto__.push((arguments[i__5770__auto___43794]));

var G__43795 = (i__5770__auto___43794 + (1));
i__5770__auto___43794 = G__43795;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq43512){
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43580_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__43580_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__43581_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__43581_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__43582){
var vec__43583 = p__43582;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43583,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43583,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43586_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__43586_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__43615 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__43617;
var lines = seq__43616__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43604_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43604_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__43633 = in$;
var seq__43634 = cljs.core.seq(vec__43633);
var first__43635 = cljs.core.first(seq__43634);
var seq__43634__$1 = cljs.core.next(seq__43634);
var k = first__43635;
var rst = seq__43634__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__43636 = show_valid_values_QMARK_;
var G__43637 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__43638 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__43636,G__43637,G__43638) : expound.printer.summary_form.call(null,G__43636,G__43637,G__43638));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__43856 = show_valid_values_QMARK_;
var G__43857 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__43858 = rst__$1;
show_valid_values_QMARK_ = G__43856;
form = G__43857;
in$ = G__43858;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__43639 = show_valid_values_QMARK_;
var G__43640 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__43641 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__43639,G__43640,G__43641) : expound.printer.summary_form.call(null,G__43639,G__43640,G__43641));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__43642 = show_valid_values_QMARK_;
var G__43643 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__43644 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__43642,G__43643,G__43644) : expound.printer.summary_form.call(null,G__43642,G__43643,G__43644));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__43645 = show_valid_values_QMARK_;
var G__43646 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__43647 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__43645,G__43646,G__43647) : expound.printer.summary_form.call(null,G__43645,G__43646,G__43647));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__43648 = show_valid_values_QMARK_;
var G__43649 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__43650 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__43648,G__43649,G__43650) : expound.printer.summary_form.call(null,G__43648,G__43649,G__43650));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43651_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43651_SHARP_)).length);
...
var map__43653 = problem;
var map__43653__$1 = cljs.core.__destructure_map(map__43653);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43653__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43653__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__43655 = opts;
var map__43655__$1 = cljs.core.__destructure_map(map__43655);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43655__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__43659 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__43660 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__43660);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__43659);
}})();
var vec__43656 = cljs.core.re_find(regex,s);
...
var line = first__43658;
var first__43658__$1 = cljs.core.first(seq__43657__$1);
var seq__43657__$2 = cljs.core.next(seq__43657__$1);
var prefix = first__43658__$1;
var _more = seq__43657__$2;
