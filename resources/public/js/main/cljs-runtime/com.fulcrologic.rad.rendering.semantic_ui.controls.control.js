...
var options__50845__auto___93206 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960),(function (_,___$1,___$2){
return true;
...
var map__93202 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(_) : com.fulcrologic.fulcro.components.props.call(null,_));
var map__93202__$1 = cljs.core.__destructure_map(map__93202);
var report_env = map__93202__$1;
var instance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93202__$1,new cljs.core.Keyword(null,"instance","instance",-2121349050));
var control = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93202__$1,new cljs.core.Keyword(null,"control","control",1892578036));
var control_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93202__$1,new cljs.core.Keyword(null,"control-key","control-key",-1287294483));
var input_factory = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93202__$1,new cljs.core.Keyword(null,"input-factory","input-factory",-1266208972));
var controls = com.fulcrologic.rad.control.component_controls.cljs$core$IFn$_invoke$arity$1(instance);
var map__93203 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(controls,control_key,control);
var map__93203__$1 = cljs.core.__destructure_map(map__93203);
var control__$1 = map__93203__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93203__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var onChange = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93203__$1,new cljs.core.Keyword(null,"onChange","onChange",-312891301));
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93203__$1,new cljs.core.Keyword(null,"action","action",-811238024));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93203__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93203__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
var user_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93203__$1,new cljs.core.Keyword(null,"user-props","user-props",-1594547727));
if(cljs.core.truth_((function (){var and__5043__auto__ = input_factory;
 ...
 * @constructor
 */
com.fulcrologic.rad.rendering.semantic_ui.controls.control.Control = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__50845__auto___93206,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(com.fulcrologic.rad.rendering.semantic_ui.controls.control.Control,new cljs.core.Keyword("com.fulcrologic.rad.rendering.semantic-ui.controls.control","Control","com.fulcrologic.rad.rendering.semantic-ui.controls.control/Control",344581963),options__50845__auto___93206);
